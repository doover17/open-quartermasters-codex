---
id: honeyed-hardtack
name: Honeyed Hardtack (bundle of six)
category: consumable
subcategory: culinary
price: {village: 8 cp, city: 1 sp, scarcity: 5 sp}
resale: "—"
weight: 1 lb.
availability: common
sold_by: [baker, general-store, provisioner]
systems:
  dnd5e:
...
- The reliable peace offering: handed to a crying child, a suspicious guard's kid, or a companion sulking at the far edge of the firelight.
- A grizzled character caught keeping a private stash has been characterized in one sentence.

## Hooks

Every stamp in the region is registered with the bakers' guild except one — a seven-petaled flower that keeps turning up in bundles nobody remembers buying. The biscuits are excellent. The honey is from no hive anyone can name.
