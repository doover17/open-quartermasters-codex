...
**Masterwork floors.** Merged masterwork items price at 20 gp (`masterwork-crowbar`),
35 gp (`masterwork-boots`), 150 gp (`masterwork-lockbox`), and 200 gp
(`masterwork-smiths-tools`). Masterwork is a price band as much as a multiplier: on even the
humblest base item it should not fall below ~20–30 gp, because the tier's identity — a
maker's mark, resale that holds — has a minimum cost regardless of the anchor. If your
masterwork item lands under ~10× and reads as cheap beside these, the multiplier is wrong or
the item isn't masterwork.
